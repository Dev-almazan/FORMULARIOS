...
$compdo = $_FILES['compdo'];    
    ...
    $mail = new PHPMailer(); 
    $mail->From     = "pruebas@libemprende.com.mx";
...
// Aquí van los datos que apareceran en el correo que reciba
    ...
    $mail->Body     =  "Formulario Cliente-Libérate:\n<br />".
    "Nombre: $nombre \n<br />".
    "Apellido:$apellido \n<br />".
    "Email: $correo \n<br />".
    "Telefono: $telefono \n<br />".
...
// Datos del servidor SMTP
    ...
    $mail->SMTPAuth = true; 
    $mail->Username = "pruebas@libemprende.com.mx";  // Correo Electrónico para SMTP correo@dominio.tld
    $mail->Password = "*WEB2020*WEB2020"; // Contraseña para SMTP
    $mail->CharSet = 'UTF-8';    
    if ($mail->Send()){
    echo "<script>
                window.location= 'https://libemprende.com.mx/';
    </script>";
